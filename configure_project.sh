...
sed -i s/${DUMMY_MODULE^}/${MODULE^}/g tests/test_app.py
sed -i s/$DUMMY_MODULE/$MODULE/g k8s/app.yaml
...
sed -i s/${DUMMY_MODULE^}/${MODULE^}/g $DUMMY_MODULE/app.py
sed -i s/${DUMMY_MODULE^}/${MODULE^}/g $DUMMY_MODULE/__main__.py
sed -i s/${DUMMY_MODULE^}/${MODULE^}/g $DUMMY_MODULE/__init__.py
